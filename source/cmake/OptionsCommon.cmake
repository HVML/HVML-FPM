...
HVMLFCGI_CHECK_HAVE_INCLUDE(HAVE_FEATURES_H features.h)

# Check for headers
HVMLFCGI_CHECK_HAVE_INCLUDE(HAVE_PWD_H pwd.h)
HVMLFCGI_CHECK_HAVE_INCLUDE(HAVE_GETOPT_H getopt.h)
HVMLFCGI_CHECK_HAVE_INCLUDE(HAVE_ERRNO_H errno.h)
HVMLFCGI_CHECK_HAVE_INCLUDE(HAVE_LANGINFO_H langinfo.h)
HVMLFCGI_CHECK_HAVE_INCLUDE(HAVE_MMAP sys/mman.h)
HVMLFCGI_CHECK_HAVE_INCLUDE(HAVE_PTHREAD_NP_H pthread_np.h)
HVMLFCGI_CHECK_HAVE_INCLUDE(HAVE_SYS_PARAM_H sys/param.h)
HVMLFCGI_CHECK_HAVE_INCLUDE(HAVE_SYS_TIME_H sys/time.h)
HVMLFCGI_CHECK_HAVE_INCLUDE(HAVE_SYS_TIMEB_H sys/timeb.h)
HVMLFCGI_CHECK_HAVE_INCLUDE(HAVE_SYS_WAIT_H sys/wait.h)
HVMLFCGI_CHECK_HAVE_INCLUDE(HAVE_LINUX_MEMFD_H linux/memfd.h)
HVMLFCGI_CHECK_HAVE_INCLUDE(HAVE_SYSLOG_H syslog.h)

# Check for functions
HVMLFCGI_CHECK_HAVE_FUNCTION(HAVE_ALIGNED_MALLOC _aligned_malloc)
HVMLFCGI_CHECK_HAVE_FUNCTION(HAVE_ISDEBUGGERPRESENT IsDebuggerPresent)
HVMLFCGI_CHECK_HAVE_FUNCTION(HAVE_LOCALTIME_R localtime_r)
HVMLFCGI_CHECK_HAVE_FUNCTION(HAVE_MALLOC_TRIM malloc_trim)
HVMLFCGI_CHECK_HAVE_FUNCTION(HAVE_STRNSTR strnstr)
HVMLFCGI_CHECK_HAVE_FUNCTION(HAVE_TIMEGM timegm)
HVMLFCGI_CHECK_HAVE_FUNCTION(HAVE_VASPRINTF vasprintf)
HVMLFCGI_CHECK_HAVE_FUNCTION(HAVE_VSYSLOG vsyslog)
HVMLFCGI_CHECK_HAVE_FUNCTION(HAVE_ALLOCA alloca)
HVMLFCGI_CHECK_HAVE_FUNCTION(HAVE_ISSETUGID issetugid)
HVMLFCGI_CHECK_HAVE_FUNCTION(HAVE_INET_PTON inet_pton)

# Check for symbols
HVMLFCGI_CHECK_HAVE_SYMBOL(HAVE_REGEX_H regexec regex.h)
if (NOT (${CMAKE_SYSTEM_NAME} STREQUAL "Darwin"))
HVMLFCGI_CHECK_HAVE_SYMBOL(HAVE_PTHREAD_MAIN_NP pthread_main_np pthread_np.h)
endif ()
# Windows has signal.h but is missing symbols that are used in calls to signal.
HVMLFCGI_CHECK_HAVE_SYMBOL(HAVE_SIGNAL_H SIGTRAP signal.h)

# Check for struct members
HVMLFCGI_CHECK_HAVE_STRUCT(HAVE_STAT_BIRTHTIME "struct stat" st_birthtime sys/stat.h)
HVMLFCGI_CHECK_HAVE_STRUCT(HAVE_TM_GMTOFF "struct tm" tm_gmtoff time.h)
HVMLFCGI_CHECK_HAVE_STRUCT(HAVE_TM_ZONE "struct tm" tm_zone time.h)
HVMLFCGI_CHECK_HAVE_STRUCT(HAVE_IPV6 "struct sockaddr_in6" s6_addr sys/socket.h)
