...
CALCULATE_LIBRARY_VERSIONS_FROM_LIBTOOL_TRIPLE(HVMLFCGI 0 0 0)
...
add_definitions(-DHVMLFCGI_API_VERSION_STRING="${HVMLFCGI_API_VERSION}")
...
# and the option is not relevant to any other HVMLFcgi ports.
#HVMLFCGI_OPTION_DEFINE(USE_SYSTEMD "Whether to enable journald logging" PUBLIC ON)

# Private options specific to the HybridOS port. Changing these options is
# completely unsupported. They are intended for use only by HVMLFcgi developers.
#HVMLFCGI_OPTION_DEFINE(USE_ANGLE_WEBGL "Whether to use ANGLE as WebGL backend." PRIVATE OFF)
#HVMLFCGI_OPTION_DEPEND(ENABLE_WEBGL ENABLE_GRAPHICS_CONTEXT_GL)
